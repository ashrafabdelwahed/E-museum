...
<div class="sl-pagebody">
    <div class="sl-page-title">
        <h5> {{ __('admin.create_antique') }} </h5>
    </div><!-- sl-page-title -->

    <div class="card pd-20 pd-sm-40">
        <div class="form-layout">
            <form action="{{ route('antique.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mg-b-10-force">
                            ...
                            <select class="form-control select2" data-placeholder="Choose country"
                                ...
                                <option label="Choose Civilization"></option>

                                @foreach($civilizations as $civilization)
                                <option value="{{ $civilization->id }}">{{ $civilization->name_en }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div><!-- col-6 -->
